...
ws.title('Dog Adoption Center - Delete a Dog')
ws['bg']='#FFD985'
...
def nextPage():
    DogData.deleteDog(doglist, [p_name.get(), p_age.get(), DogData.dog_gender(val.get()), p_breed.get()])
    ws.destroy()
    import DeleteADog_Confirmation
